function [value,consumption_1,consumption_2] = valueFunction_setLaborToSteadyState(kPrime,ik,k,ia,a_1,a_2,expectedValue0,bbeta,mmu_1,mmu_2,ddelta,aalphaK,aalphaL,labor_1_SteadyState,labor_2_SteadyState)
    ...
    labor_1 = labor_1_SteadyState;
    labor_2 = labor_2_SteadyState;
    consumption_1 = consumptionFunction1(a_1,k,kPrime,labor_1,aalphaK,aalphaL,ddelta);
    consumption_2 = consumptionFunction2(a_2,labor_2);
    ...
    if (consumption_1 >= 0) && (consumption_2 >= 0)  
