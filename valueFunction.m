function [value,labor_1,labor_2,consumption_1,consumption_2] = valueFunction(kPrime,k,ia,a_1,a_2,expectedValue0,bbeta,mmu_1,mmu_2,ddelta,aalphaK,aalphaL)
...
if (consumption_1 >= 0) && (labor_1 >= 0) && (currentUtility >= 0)...
