...
% Lab computer
% Elapsed time is 386.061909 seconds.
% Elapsed time is 56.768395 seconds. % lab computer, Nk=50, spread=0.15
...
%  Iteration: 11, Sup diff: 0.00051626
%  Iteration: 21, Sup diff: 0.00027409
%  Iteration: 31, Sup diff: 0.00015866
%  Iteration: 41, Sup diff: 0.00009561
%  Iteration: 51, Sup diff: 0.00005871
%  Iteration: 61, Sup diff: 0.00003641
%  Iteration: 71, Sup diff: 0.00002272
%  Iteration: 81, Sup diff: 0.00001425
%  Iteration: 91, Sup diff: 0.00000897
%  Iteration: 101, Sup diff: 0.00000567
%  Iteration: 111, Sup diff: 0.00000360
%  Iteration: 121, Sup diff: 0.00000229
%  Iteration: 131, Sup diff: 0.00000146
% Elapsed time is 2.163193 seconds.
% Convergence Achieved. Iteration: 140, Sup diff: 0.00000098
...
%     mConsumption_2 = mGrid_a1a2(:,2)' * labor_2_SteadyState;% NkPrime by Na
    ...
    mEndogenousOutput = mConsumption_1 + vGrid_kPrime;% NkPrime by Na
    
%     getEndogenousCapitalFunction = @(mEndogenousCapital) mGrid_a1a2(:,1)'.*mEndogenousCapital.^aalphaK*labor_1_SteadyState^aalphaL + (1-ddelta)*mEndogenousCapital - mEndogenousOutput;
%     mEndogenousCapital = fsolve(getEndogenousCapitalFunction,kSteadyState);  % NkPrime by Na
